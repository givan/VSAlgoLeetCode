...
namespace Algo.Tests
{
    ...
    public class FindMaxProfitTests
    {
        ...
        {
            int maxProfit = FindMaxProfit.Solve(new int[] { 1, 1, 2 });
        ...
        {
            int maxProfit = FindMaxProfit.Solve(new int[] { 1, 3, 4, 5, 7 });
        ...
        {
            int maxProfit = FindMaxProfit.Solve(new int[] { 1, 1, 1, 1, 1 });
        ...
        {
            int maxProfit = FindMaxProfit.Solve(new int[] { 1, 1, 1, 2, 2 });
        ...
        {
            int maxProfit = FindMaxProfit.Solve(new int[] { 6, 5, 4, 3, 2, 1 });
