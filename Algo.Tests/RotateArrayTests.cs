...
namespace Algo.Tests
{
    ...
    public class RotateArrayTests
    {
        ...
        {
            int[] rotated = RotateArray.Rotate(new int[] { 1, 2, 3, 4, 5 }, 2);
            CollectionAssert.AreEqual(new int[] { 4, 5, 1, 2, 3 }, rotated);
        }

        [TestMethod]
        public void RotateArray_SuccessOneElementTests()
        {
            int[] rotated = RotateArray.Rotate(new int[] { 1 }, 0);
            CollectionAssert.AreEqual(new int[] { 1 }, rotated);
        }

        [TestMethod]
        public void RotateArray_Rotate0timesTest()
        {
            int[] rotated = RotateArray.Rotate(new int[] { 1, 2, 3, 4, 5 }, 0);
            CollectionAssert.AreEqual(new int[] { 1, 2, 3, 4, 5 }, rotated);
        }

        [TestMethod]
        public void RotateArray_Rotate1timesTest()
        {
            int[] rotated = RotateArray.Rotate(new int[] { 1, 2, 3, 4, 5 }, 1);
            CollectionAssert.AreEqual(new int[] { 5, 1, 2, 3, 4 }, rotated);
        }
        ...
        {
            int[] rotated = RotateArray.Rotate(new int[] { 1, 2 }, 5);
            CollectionAssert.AreEqual(new int[] { 2, 1 }, rotated);
        }
